...
if(isset($_GET['msg'])){
  $msg = $_GET['msg'];
  $id = $_GET['id'];
  $sqlEdit = "SELECT * FROM barang WHERE id_barang = '$id'";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?= $msg != '' ? 'Edit Barang' :
              'Add Barang' ?></li>
                ...
                <div class="card-body">
                    <div class="col-lg-8 mb-3 pr-3">
                        ...
                        <div class="form-group">
                                ...
                                value="<?= $msg != '' ? $barang['barcode']
                                : null ?>" autocomplete="off" autofocus required>
                        </div>

                        <div class="form-group">
                                <label for="name">Nama *</label>
                                <input type="text" name="name" class="form-control" id="name" 
                                value="<?= $msg != '' ? $barang['nama_barang']
                                : null ?>" placeholder="nama barang" autocomplete="off" autofocus required>
                        </div>
                        ...
                        <div class="form-group">
                                ...
                                value="<?= $msg != '' ? $barang['harga_beli']
                                : null ?>" placeholder="Rp 0" autocomplete="off" required>
                        </div>

                        <div class="form-group">
                                <label for="harga_jual">Harga Jual *</label>
                                <input type="number" name="harga_jual" class="form-control" id="harga_jual" 
                                value="<?= $msg != '' ? $barang['harga_jual']
                                : null ?>" placeholder="Rp 0" autocomplete="off" required>
                        </div>
                        ...
                        <div class="form-group">
                                ...
                                valu="<?= $msg != '' ? $barang['stock_minimal']
                                : null ?>" placeholder="0" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="col-lg-4 text-center px-3">
                        <input type="hidden" name="oldImg" value="<?= $msg != '' ? $barang['gambar']
                                : null ?>">
                        <img src="<?= $main_url ?>asset/image/<?= $msg != '' ? $barang['gambar']
                                : 'barang.png' ?>" class="profile-user-image mb-3 mt-4" 
                        alt="" style="max-width: 20%; height: auto;">
