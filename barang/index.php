            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-list fa-sm"></i> Tambah Barang</h3>
                        <a href="<?= $main_url ?>barang/form-barang.php" class="mr-2 btn btn-sm btn-primary float-right">
                        <i class="fas fa-plus"></i> Barang</a>
                    </div>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach ($barang as $brg){ ?>
                                        <tr>
                                            <td>
                                                <img src="../asset/image/<?= $brg['gambar'] ?>" alt="gambar barang" 
                                            ...
                                            <td>
                                                ...
                                                <a href="form-barang.php?id=<?= $brg['id_barang'] ?>&gbr=<?= $brg['gambar'] ?>&msg=editing" class="btn btn-warning btn-sm"
                                                title="edit barang">
                                                <i class="fas fa-pen"></i></a>
                        
                                                <a href="?id=<?= $brg['id_barang'] ?>&gbr=<?= $brg['gambar'] ?>&msg=deleted" class="btn btn-danger btn-sm" 
                                                title="hapus barang" onclick="return confirm('Anda yakin ingin menghapus barang ini?')"><i class="fas fa-trash"></i>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php
            ...
            <div class="modal-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    value="1" title="maximal 10" class="form-control" id="jmlCetak">
                </div>
              </div>
