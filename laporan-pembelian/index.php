...
$title = "Laporan - SIRohand";
require "../template/header.php";
require "../template/navbar.php";
require "../template/sidebar.php";

$pembelian = getData("SELECT * FROM head_beli");
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card-header">
                        ...
                        btn-outline-primary float-right" data-toggle="modal" 
                                ...
                                foreach($pembelian as $beli){ ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="detail-pembelian.php?id=<?=
                                            $beli['no_beli'] ?>&tgl=<?= in_date($beli['tgl_beli']) ?>"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              ()"><i class="fas fa-print"> Cetak</i></button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
