        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= $main_url ?>data-user.php">Users</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 mb-3">
                            <div class="form-group">
                                ...
                                <select name="level" class="form-control" id="level" class="form-control" required>
                        ...
                        <div class="col-lg-8 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="address" id="address" cols="" rows="3" 
                                placeholder="masukkan alamat user" class="form-control" value="<?= $user['address'] ?>" required></textarea>
                            </div>
                        </div>
