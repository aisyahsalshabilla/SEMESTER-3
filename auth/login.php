...
<head>
  ...
  <!-- favicon -->
  <link rel="short icon" href="<?= $main_url ?>asset/image/chart.png" type="image/x-icon">
...
<div class="login-box slide-down" style="margin-top: -70px;">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="" class="h1"><b>SIRohand</b>POS</a>
    </div>
    <div class="card-body">
      ...
      <p class="my-3 text-center">
        <strong>Copyright $copy; 2023 <span class="text-info">MIFINT1</span></strong>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
