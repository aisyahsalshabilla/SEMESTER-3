...
$kode = @$_GET['pilihbarang'] ? @$_GET['pilihbarang'] : '';
if($kode){
  $selectBrg = getData("SELECT * FROM barang WHERE id_barang = '$kode'")[0];
}
...
<div class="content-wrapper">
        ...
        <form action="" method="post">
                  ...
                  <div class="col-sm-10">
                    <select name="kodeBrg" id="kodeBrg" class="form-control">
                      ...
                      foreach($barang as $brg){ ?>
                        <option value="?pilihbarang=<?= $brg
                        ['id_barang'] ?> <?= @$_GET['pilihbarang'] == $brg['id_barang'] ? 'selected' : null 
              ...
              <div class="row">
                  <div class="col-lg-4">
                      <div class="form-group">
                        <input type="hidden" value="<?= @$_GET['pilihbarang'] ?
                        $selectBrg['nama_barang'] : '' ?>" name="kodeBrg">
                          <label for="namaBrg">Nama Barang</label>
                          <input type="text" name="namaBrg" class="form-control 
                          form-control-sm" id="namaBrg" value="<?= @$_GET['pilihbarang'] ?
                        $selectBrg['nama_barang'] : '' ?>" readonly>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-1">
                      <div class="form-group">
                          ...
                          form-control-sm" id="stok" value="<?= @$_GET['pilihbarang'] ?
                        $selectBrg['stock'] : '' ?>" readonly>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-1">
                      <div class="form-group">
                          ...
                          form-control-sm" id="satuan" value="<?= @$_GET['pilihbarang'] ?
                          $selectBrg['satuan'] : '' ?>" readonly>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-2">
                      <div class="form-group">
                          ...
                          form-control-sm" id="harga" value="<?= @$_GET['pilihbarang'] ?
                          $selectBrg['harga_beli'] : '' ?>" readonly>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-2">
                      <div class="form-group">
                          ...
                          form-control-sm" id="qty" value="<?= @$_GET['pilihbarang'] ?
                          1 : '' ?>">
                      </div>
                  </div>
                  ...
                  <div class="col-lg-2">
                      <div class="form-group">
                          ...
                          <input type="number" name="jmlHarga" class="form-control
                          form-control-sm" id="jmlHarga" value="<?= @$_GET['pilihbarang'] ?
                          $selectBrg['harga_beli'] : '' ?>" readonly>
                      </div>
                  </div>
              </div>
              ...
              <tbody>
                ...
                foreach ($brgDetail as $detail){ ?>
                  <tr>
                    ...
                    <td class="text-right"><?= number_format($detail
                    ['harga_beli'],0,',','.') ?></td>
                    <td><?= $detail['qty'] ?></td>
                    <td class="text-right"><?= number_format($detail
                    ['jml_harga'],0,',','.') ?></td>
                    <td class="text-center">
                      ...
                      idbeli=<?= $detail['no_beli'] ?>&qty=<?= $detail['qty'] ?>&
                      tgl=<?= $detail['tgl_beli'] ?>&msg=deleted" class="btn btn-sm btn-danger" 
                      title="hapus barang" onclick="return confirm('Anda yakin akan menghapus barang ini?')">
          ...
          <div class="row">
            <div class="col-lg-6 p-2">
                <div class="form-group row mb-2">
                  <label class="col-sm-3 form-label col-form-label-sm" 
                  for="suplier">Suplier</label>
                  <div class="col-sm-9">
                ...
                <div class="form-group row mb-2">
                  <label for="ketr" class="col-sm-3">Keterangan</label>
                  <div class="col-sm-9">
            ...
            <div class="col-lg-6 p-2">
              ...
              class="btn btn-primary btn-sm btn-block"><i class="fas fa-save"></i> Simpan</button>
            </div>
          </div>
        </form>
      </div>
    ...
    <script>
      let pilihbarang = document.getElementById('kodeBrg');
