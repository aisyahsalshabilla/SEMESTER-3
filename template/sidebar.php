...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= $main_url ?>dashboard.php" class="brand-link">
      <img src="<?= $main_url ?>asset/image/emba.png" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">SIRohand</span>
    </a>
