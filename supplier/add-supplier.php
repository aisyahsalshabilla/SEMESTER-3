...
$title = "Tambah Supplier - SIRohand";
...
if(isset($_POST['simpan'])){
    if(insert($_POST)){
        ...
        role="alert">
        <i class="icon fas fas-check"></i> Supplier berhasil ditambahkan
                    ...
                    <div class="row">
                        <div class="col-lg-8 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                placeholder="nomor telepon supplier"pattern="[0-9]{5, }" title="minimal 5 angka" required>
                            </div>

                            <div class="form-group">
                                <label for="keterangan">Deskripsi</label>
                                <textarea type="text" name="keterangan" class="form-control" id="keterangan" 
                                placeholder="keterangan supplier" rows="1" required></textarea>
                            </div>

                            <div class="form-group">
                                <label for="alamat">Alamat</label>
                                <textarea type="text" name="alamat" class="form-control" id="alamat" 
                                placeholder="alamat supplier" rows="3" required></textarea>
                            </div>
