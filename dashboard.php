              ...
              <div class="col-lg-6">
                <div class="card card-outline card-danger">
                  <div class="card-header text-info">
                    ...
                    <h5><a href="stock" class="float-right" title="laporan
                    stock"><i class="fas fa-arrow-right"></i></a></h5>
                  </div>
                  <table class="table">
                    <tbody>
                      <?php
                      $stockMin = getData("SELECT * FROM barang WHERE stock < stock_minimal");
