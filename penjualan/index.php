...
if ($kode) {
    $tgl = $_GET['tgl'];
    $dataBrg = mysqli_query($koneksi, "SELECT * FROM barang WHERE barcode = 
    '$kode'");
    ...
    if(simpan($_POST)){
      echo "<script>
                ...
                if (win) {
                    ...
                    // Handle jika pemblokiran popup atau kesalahan membuka jendela
              ...
              <div class="row">
                  <div class="col-lg-4">
                      <div class="form-group">
                        <input type="hidden" value="<?= @$_GET['barcode'] ?
                        $selectBrg['barcode'] : '' ?>" name="barcode">
                          <label for="namaBrg">Nama Barang</label>
                          <input type="text" name="namaBrg" class="form-control 
                          form-control-sm" id="namaBrg" value="<?= @$_GET['barcode'] ?
                  ...
                  <div class="col-lg-1">
                      <div class="form-group">
                          ...
                          form-control-sm" id="stok" value="<?= @$_GET['barcode'] ?
                  ...
                  <div class="col-lg-1">
                      <div class="form-group">
                          ...
                          form-control-sm" id="satuan" value="<?= @$_GET['barcode'] ?
                  ...
                  <div class="col-lg-2">
                      <div class="form-group">
                          ...
                          form-control-sm" id="harga" value="<?= @$_GET['barcode'] ?
                          $selectBrg['harga_jual'] : '' ?>" readonly>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-2">
                      <div class="form-group">
                          ...
                          form-control-sm" id="qty" value="<?= @$_GET['barcode'] ?
                          1 : '' ?>">
                      </div>
                  </div>
                  ...
                  <div class="col-lg-2">
                      <div class="form-group">
                          ...
                          form-control-sm" id="jmlHarga" value="<?= @$_GET['barcode'] ?
                          $selectBrg['harga_jual'] : '' ?>" readonly>
                      </div>
                  </div>
              </div>
                ...
                foreach ($brgDetail as $detail){ ?>
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      idjual=<?= $detail['no_jual'] ?>&qty=<?= $detail['qty'] ?>&
                      tgl=<?= $detail['tgl_jual'] ?>&msg=deleted" class="btn btn-sm btn-danger" 
            ...
            <div class="col-lg-4 py-2 px-3">
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-9">
                        ...
                        form-control-sm text-right" id="bayar">
                    </div>
                </div>
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-9">
                        ...
                        form-control-sm text-right" id="kembalian" readonly>
                    </div>
                </div>
            </div>
