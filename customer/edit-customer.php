                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 mb-3">
                            <div class="form-group">
                                ...
                                placeholder="nama supplier" autofocus value="<?= $customer['nama'] ?>"  required>
                            </div>

                            <div class="form-group">
                                <label for="telpon">Telpon</label>
                                <input type="text" name="telpon" class="form-control" id="telpon" 
                                placeholder="nomor telepon supplier"pattern="[0-9]{5, }" 
                            ...
                            <div class="form-group">
                                ...
                                placeholder="keterangan supplier" rows="1" required><?= $customer['deskripsi'] ?></textarea>
                            </div>

                            <div class="form-group">
                                <label for="alamat">Alamat</label>
                                <textarea type="text" name="alamat" class="form-control" id="alamat" 
                                placeholder="alamat supplier" rows="3" required><?= $customer['alamat'] ?></textarea>
                            </div>
